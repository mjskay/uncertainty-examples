...
```{r}
# X_star = c(1,2,3,5,9,10.5)
X_star = c(1,2,3,3,3,3,5,9,10.5)
# X_star = c(1,2,3,3,3,3,3,3,3,3,3,3,5,9,10.5)
...
quantile_plot = function(inverse_cdf, type, bounds = discontinuous_quantile_bounds) {
  (
    ggplot() +
      bounds(X_star, w_star) +
...
discontinuous_quantile_plot = \(...) quantile_plot(..., bounds = discontinuous_quantile_bounds)
