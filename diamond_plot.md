...
A disadvantage of diamond plots like this is that more uncertain
estimates become visually larger. You could make the diamonds shrink
their vertical height in proportion to their uncertainty, to better
mimic how densities (which have equal area) would look. We can do this
by calculating the width of the interval and making the thickness at the
...
<img src="diamond_plot_files/figure-gfm/unnamed-chunk-6-1.png" width="672" />
